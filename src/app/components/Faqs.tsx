          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className=" mb-14">
              ...
              >
                ...
                <span className="text-sm font-medium tracking-wider uppercase">Česta pitanja</span>
              </motion.div>
              ...
              <motion.h2
                ...
                className="text-4xl text-stone-900 sm:text-4xl md:text-5xl leading-tight tracking-tight font-playfair "
              >
                Imate pitanja?
                <br />
                ...
                >
                  <div className="p-5 md:p-6">
                    <div className="flex items-center gap-4">
                      ...
                      >
                        {icons[faq.icon as IconKey]}
                      </div>

                      {/* Question */}
                      <h3 className="flex-1 text-[16px] md:text-[20px] text-black/80 ">
                        {faq.question}
                      </h3>
                    ...
                    <AnimatePresence>
                      {selectedIndex === index && (
                        ...
                        >
                          <p className="mt-4 p-4 md:p-0 pl-4 md:pl-16 leading-relaxed text-base text-black/50">
                            {faq.answer}
                          </p>
                        </motion.div>
                      )}
