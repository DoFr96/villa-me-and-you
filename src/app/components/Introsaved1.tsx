  ...
  return (
    <div className="w-full px-2 sm:px-3  overflow-hidden ">
      <div className="h-full w-full rounded-[2rem] bg-white overflow-hidden">
        <section className=" max-w-[1500px] mx-auto  px-6 sm:px-12 lg:px-20 py-20 sm:py-28 lg:py-32 ">
          <div className="flex md:flex-row flex-col justify-between gap-10">
            ...
            <div className="flex-1 flex flex-col justify-center gap-10">
              ...
              <div className="flex md:flex-row flex-col  gap-10">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <h2 className="text-4xl leading-normal tracking-wide font-playfair">
                    Unikatna villa za{' '}
              ...
              <div className="flex flex-row justify-between">
                ...
                <p className="flex flex-col items-center gap-1">
                  <Bed /> <span className="font-medium tracking-wide">2 + 1</span>
                </p>
                <p className="flex flex-col items-center gap-1">
            ...
            {/*DESNA STRANA*/}
            <div className="relative md:aspect-[5/4] aspect-[5/5] md:w-1/2 w-full rounded-2xl">
              <Image
